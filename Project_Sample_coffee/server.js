...
server.register([require('vision'),require('inert')], (err) => {
  ...
  server.route({
    method:'GET',
    path:'/helpers/controllers/build/{param*}',
    handler:{
      directory:{
        path:'./helpers/controllers/build/',
        listing:false,
        index:false}}});
  server.route({
    method:'GET',
  ...
  server.route({
    method:'GET',
    path:'/helpers/services/build/{param*}',
    handler:{
      directory:{
        path:'./helpers/services/build/',
        listing:false,
        index:false}}});
  server.route({
    method:'GET',
    path:'/helpers/directives/build/{param*}',
    handler:{
      directory:{
        path:'./helpers/directives/build/',
        listing:false,
        index:false}}});
  server.route({
    method:'GET',
